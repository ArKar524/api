                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-cars">GET api/cars</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-owner-cars">
                                <a href="#endpoints-GETapi-owner-cars">GET api/owner/cars</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-owner-kyc">
                                <a href="#endpoints-POSTapi-owner-kyc">POST api/owner/kyc</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-admin-verifications--id--review">POST api/admin/verifications/{id}/review</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-admin-cars--id--review">
                                <a href="#endpoints-POSTapi-admin-cars--id--review">POST api/admin/cars/{id}/review</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="per_page"                data-endpoint="GETapi-cars"
               value="22"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="sort"                data-endpoint="GETapi-cars"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="q"                data-endpoint="GETapi-cars"
               value="n"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="filter.price_min"                data-endpoint="GETapi-cars"
               value="4326.41688"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="filter.price_max"                data-endpoint="GETapi-cars"
               value="4326.41688"
               data-component="body">
    <br>
<p>Example: <code>4326.41688</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="filter.car_id"                data-endpoint="GETapi-cars"
               value="16"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="filter.driver_id"                data-endpoint="GETapi-cars"
               value="16"
               data-component="body">
    <br>
<p>Example: <code>16</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="filter.owner_id"                data-endpoint="GETapi-cars"
               value="16"
               data-component="body">
    <br>
<p>Example: <code>16</code></p>
                                                                ...
                                                                <div style="margin-left: 14px; clear: unset;">
                        <b style="line-height: 2;"><code>start_at_from</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
...
<p>Must be a valid date. Example: <code>2026-01-22T18:42:30</code></p>
                    ...
                    <h2 id="endpoints-GETapi-owner-cars">GET api/owner/cars</h2>
...
<span id="example-requests-GETapi-owner-cars">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-GETapi-owner-cars">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-owner-cars" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-owner-cars"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-owner-cars"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-owner-cars" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-owner-cars">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-owner-cars" data-method="GET"
      data-path="api/owner/cars"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-owner-cars', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-owner-cars"
                    onclick="tryItOut('GETapi-owner-cars');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-owner-cars"
                    onclick="cancelTryOut('GETapi-owner-cars');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-owner-cars"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-owner-cars"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-owner-cars"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="page"                data-endpoint="GETapi-owner-cars"
               value="16"
               data-component="body">
    <br>
<p>Must be at least 1. Example: <code>16</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="per_page"                data-endpoint="GETapi-owner-cars"
               value="22"
               data-component="body">
    <br>
<p>Must be at least 1. Must not be greater than 100. Example: <code>22</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="sort"                data-endpoint="GETapi-owner-cars"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="q"                data-endpoint="GETapi-owner-cars"
               value="n"
               data-component="body">
    <br>
<p>Must not be greater than 100 characters. Example: <code>n</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="filter.price_min"                data-endpoint="GETapi-owner-cars"
               value="4326.41688"
               data-component="body">
    <br>
<p>Example: <code>4326.41688</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="filter.price_max"                data-endpoint="GETapi-owner-cars"
               value="4326.41688"
               data-component="body">
    <br>
<p>Example: <code>4326.41688</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="filter.car_id"                data-endpoint="GETapi-owner-cars"
               value="16"
               data-component="body">
    <br>
<p>Example: <code>16</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="filter.driver_id"                data-endpoint="GETapi-owner-cars"
               value="16"
               data-component="body">
    <br>
<p>Example: <code>16</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="filter.owner_id"                data-endpoint="GETapi-owner-cars"
               value="16"
               data-component="body">
    <br>
<p>Example: <code>16</code></p>
...
<p>Must be a valid date. Example: <code>2026-01-22T18:42:30</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-owner-kyc">POST api/owner/kyc</h2>
...
<span id="example-requests-POSTapi-owner-kyc">
<blockquote>Example request:</blockquote>
...
body.append('nrc_front', document.querySelector('input[name="nrc_front"]').files[0]);
body.append('nrc_back', document.querySelector('input[name="nrc_back"]').files[0]);
body.append('selfie', document.querySelector('input[name="selfie"]').files[0]);
body.append('other_files[]', document.querySelector('input[name="other_files[]"]').files[0]);
...
<span id="example-responses-POSTapi-owner-kyc">
</span>
<span id="execution-results-POSTapi-owner-kyc" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-owner-kyc"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-owner-kyc"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-owner-kyc" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-owner-kyc">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-owner-kyc" data-method="POST"
      data-path="api/owner/kyc"
      data-authed="0"
      data-hasfiles="1"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-owner-kyc', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-owner-kyc"
                    onclick="tryItOut('POSTapi-owner-kyc');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-owner-kyc"
                    onclick="cancelTryOut('POSTapi-owner-kyc');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-owner-kyc"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-owner-kyc"
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-owner-kyc"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>file</small>&nbsp;
 ...
 &nbsp;
                <input type="file" style="display: none"
                              name="nrc_front"                data-endpoint="POSTapi-owner-kyc"
               value=""
               data-component="body">
    <br>
...
<small>file</small>&nbsp;
 ...
 &nbsp;
                <input type="file" style="display: none"
                              name="nrc_back"                data-endpoint="POSTapi-owner-kyc"
               value=""
               data-component="body">
    <br>
...
<small>file</small>&nbsp;
 ...
 &nbsp;
                <input type="file" style="display: none"
                              name="selfie"                data-endpoint="POSTapi-owner-kyc"
               value=""
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="file" style="display: none"
                              name="other_files[0]"                data-endpoint="POSTapi-owner-kyc"
               data-component="body">
        <input type="file" style="display: none"
               name="other_files[1]"                data-endpoint="POSTapi-owner-kyc"
               data-component="body">
    <br>
<p>Must be a file. Must not be greater than 8192 kilobytes.</p>
                    ...
                    <h2 id="endpoints-POSTapi-owner-cars">POST api/owner/cars</h2>
...
<span id="example-requests-POSTapi-owner-cars">
<blockquote>Example request:</blockquote>
...
body.append('make', 'n');
body.append('model', 'g');
body.append('year', '1981');
body.append('plate_number', 'm');
body.append('daily_price', '8');
body.append('deposit_amount', '76');
body.append('pickup_lat', '-89');
body.append('pickup_lng', '-179');
body.append('description', 'Eius et animi quos velit et.');
body.append('doc_types[]', 'b');
...
<span id="example-responses-POSTapi-owner-cars">
</span>
<span id="execution-results-POSTapi-owner-cars" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-owner-cars"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-owner-cars"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-owner-cars" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-owner-cars">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-owner-cars" data-method="POST"
      data-path="api/owner/cars"
      data-authed="0"
      data-hasfiles="1"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-owner-cars', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-owner-cars"
                    onclick="tryItOut('POSTapi-owner-cars');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-owner-cars"
                    onclick="cancelTryOut('POSTapi-owner-cars');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-owner-cars"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-owner-cars"
               value="multipart/form-data"
               data-component="header">
    <br>
<p>Example: <code>multipart/form-data</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-owner-cars"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="title"                data-endpoint="POSTapi-owner-cars"
               value="b"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>b</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="make"                data-endpoint="POSTapi-owner-cars"
               value="n"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="model"                data-endpoint="POSTapi-owner-cars"
               value="g"
               data-component="body">
    <br>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="year"                data-endpoint="POSTapi-owner-cars"
               value="1981"
               data-component="body">
    <br>
<p>Must be between 1980 and 2027. Example: <code>1981</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="plate_number"                data-endpoint="POSTapi-owner-cars"
               value="m"
               data-component="body">
    <br>
...
<small>number</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="daily_price"                data-endpoint="POSTapi-owner-cars"
               value="8"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="deposit_amount"                data-endpoint="POSTapi-owner-cars"
               value="76"
               data-component="body">
    <br>
...
<small>number</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="pickup_lat"                data-endpoint="POSTapi-owner-cars"
               value="-89"
               data-component="body">
    <br>
...
<small>number</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="pickup_lng"                data-endpoint="POSTapi-owner-cars"
               value="-179"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="description"                data-endpoint="POSTapi-owner-cars"
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="file" style="display: none"
                              name="photos[0]"                data-endpoint="POSTapi-owner-cars"
               data-component="body">
        <input type="file" style="display: none"
               name="photos[1]"                data-endpoint="POSTapi-owner-cars"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="file" style="display: none"
                              name="documents[0]"                data-endpoint="POSTapi-owner-cars"
               data-component="body">
        <input type="file" style="display: none"
               name="documents[1]"                data-endpoint="POSTapi-owner-cars"
               data-component="body">
    <br>
<p>Must be a file. Must not be greater than 8192 kilobytes.</p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>doc_types</code></b>&nbsp;&nbsp;
<small>string[]</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="doc_types[0]"                data-endpoint="POSTapi-owner-cars"
               data-component="body">
        <input type="text" style="display: none"
               name="doc_types[1]"                data-endpoint="POSTapi-owner-cars"
               data-component="body">
    <br>
...
<p>Must be a valid date. Example: <code>2026-01-22T18:42:30</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-driver-kyc">POST api/driver/kyc</h2>
...
<span id="example-requests-POSTapi-driver-kyc">
<blockquote>Example request:</blockquote>
...
const body = new FormData();
body.append('license_front', document.querySelector('input[name="license_front"]').files[0]);
body.append('license_back', document.querySelector('input[name="license_back"]').files[0]);
body.append('nrc_front', document.querySelector('input[name="nrc_front"]').files[0]);
body.append('nrc_back', document.querySelector('input[name="nrc_back"]').files[0]);
body.append('selfie', document.querySelector('input[name="selfie"]').files[0]);
body.append('other_files[]', document.querySelector('input[name="other_files[]"]').files[0]);
...
<span id="example-responses-POSTapi-driver-kyc">
</span>
<span id="execution-results-POSTapi-driver-kyc" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-driver-kyc"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-driver-kyc"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-driver-kyc" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-driver-kyc">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-driver-kyc" data-method="POST"
      data-path="api/driver/kyc"
      data-authed="0"
      data-hasfiles="1"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-driver-kyc', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-driver-kyc"
                    onclick="tryItOut('POSTapi-driver-kyc');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-driver-kyc"
                    onclick="cancelTryOut('POSTapi-driver-kyc');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-driver-kyc"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-driver-kyc"
               value="multipart/form-data"
               data-component="header">
    <br>
<p>Example: <code>multipart/form-data</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-driver-kyc"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                                ...
                                <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>license_front</code></b>&nbsp;&nbsp;
<small>file</small>&nbsp;
 &nbsp;
 &nbsp;
                <input type="file" style="display: none"
                              name="license_front"                data-endpoint="POSTapi-driver-kyc"
               value=""
               data-component="body">
    <br>
...
<small>file</small>&nbsp;
 ...
 &nbsp;
                <input type="file" style="display: none"
                              name="license_back"                data-endpoint="POSTapi-driver-kyc"
               value=""
               data-component="body">
    <br>
...
<small>file</small>&nbsp;
 ...
 &nbsp;
                <input type="file" style="display: none"
                              name="nrc_front"                data-endpoint="POSTapi-driver-kyc"
               value=""
               data-component="body">
    <br>
...
<small>file</small>&nbsp;
 ...
 &nbsp;
                <input type="file" style="display: none"
                              name="nrc_back"                data-endpoint="POSTapi-driver-kyc"
               value=""
               data-component="body">
    <br>
...
<small>file</small>&nbsp;
 ...
 &nbsp;
                <input type="file" style="display: none"
                              name="selfie"                data-endpoint="POSTapi-driver-kyc"
               value=""
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="file" style="display: none"
                              name="other_files[0]"                data-endpoint="POSTapi-driver-kyc"
               data-component="body">
        <input type="file" style="display: none"
               name="other_files[1]"                data-endpoint="POSTapi-driver-kyc"
               data-component="body">
    <br>
<p>Must be a file. Must not be greater than 8192 kilobytes.</p>
        </div>
...
<p>Must be a valid date. Example: <code>2026-01-22T18:42:30</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-admin-verifications--id--review">POST api/admin/verifications/{id}/review</h2>
...
<span id="example-requests-POSTapi-admin-verifications--id--review">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-admin-verifications--id--review">
</span>
<span id="execution-results-POSTapi-admin-verifications--id--review" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-admin-verifications--id--review"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-admin-verifications--id--review"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-admin-verifications--id--review" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-admin-verifications--id--review">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-admin-verifications--id--review" data-method="POST"
      data-path="api/admin/verifications/{id}/review"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-admin-verifications--id--review', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-admin-verifications--id--review"
                    onclick="tryItOut('POSTapi-admin-verifications--id--review');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-admin-verifications--id--review"
                    onclick="cancelTryOut('POSTapi-admin-verifications--id--review');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-admin-verifications--id--review"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/admin/verifications/{id}/review</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-admin-verifications--id--review"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-admin-verifications--id--review"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="POSTapi-admin-verifications--id--review"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the verification. Example: <code>architecto</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="status"                data-endpoint="POSTapi-admin-verifications--id--review"
               value="approved"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="notes"                data-endpoint="POSTapi-admin-verifications--id--review"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-admin-cars--id--review">POST api/admin/cars/{id}/review</h2>
...
<span id="example-requests-POSTapi-admin-cars--id--review">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-admin-cars--id--review">
</span>
<span id="execution-results-POSTapi-admin-cars--id--review" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-admin-cars--id--review"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-admin-cars--id--review"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-admin-cars--id--review" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-admin-cars--id--review">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-admin-cars--id--review" data-method="POST"
      data-path="api/admin/cars/{id}/review"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-admin-cars--id--review', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-admin-cars--id--review"
                    onclick="tryItOut('POSTapi-admin-cars--id--review');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-admin-cars--id--review"
                    onclick="cancelTryOut('POSTapi-admin-cars--id--review');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-admin-cars--id--review"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/admin/cars/{id}/review</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-admin-cars--id--review"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-admin-cars--id--review"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="POSTapi-admin-cars--id--review"
               value="16"
               data-component="url">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="status"                data-endpoint="POSTapi-admin-cars--id--review"
               value="rejected"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="notes"                data-endpoint="POSTapi-admin-cars--id--review"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
